...
procedure TPedidoItensModel.Setco_item(const Value: Integer);
begin
  Fco_item := Value;
end;

procedure TPedidoItensModel.Setco_produto(const Value: Integer);
begin
  Fco_produto := Value;
end;

procedure TPedidoItensModel.Setdt_cadastro(const Value: TDateTime);
begin
  Fdt_cadastro := Value;
end;

procedure TPedidoItensModel.Setnu_pedido(const Value: Integer);
begin
  Fnu_pedido := Value;
end;

procedure TPedidoItensModel.Setnu_quantidade(const Value: Double);
begin
  Fnu_quantidade := Value;
end;

procedure TPedidoItensModel.Setvl_total(const Value: Currency);
begin
  Fvl_total := Value;
end;

procedure TPedidoItensModel.Setvl_venda(const Value: Currency);
begin
  Fvl_venda := Value;
end;
