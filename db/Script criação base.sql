/******************************************************************************/
/****        Generated by IBExpert 2024.1.22.1 20/05/2024 11:35:35         ****/
/******************************************************************************/
...
/* Trigger: PEDIDO_ITENS_AIU0 */
CREATE TRIGGER PEDIDO_ITENS_AIU0 FOR PEDIDO_ITENS
ACTIVE AFTER INSERT OR UPDATE POSITION 0
AS
begin
  UPDATE PEDIDO
    SET VL_PEDIDO = (VL_PEDIDO + NEW.VL_TOTAL)
    WHERE NU_PEDIDO = NEW.NU_PEDIDO;
end
^
SET TERM ; ^
